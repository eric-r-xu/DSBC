...
def Process(table):
    ...
    no,yes = thinkstats.MeanVar(table.lengths)
    table.var=yes
...
def Summarize(data_dir):
    ...
    print 'Difference in hours', (mu1-mu2)*7*24

    print 'Standard Deviation of gestation in weeks:'
    print 'First babies', math.sqrt(var1) 
    print 'Others', math.sqrt(var2)

    std1, std2 = math.sqrt(var1), math.sqrt(var2)

    print 'Difference in days', (std1-std2) * 7.0
    print 'Difference in hours', (std1-std2)*7*24
